...
**[Pare — Subscription Manager](https://pare.kasian.dev)**
> ASP.NET Core · Clean Architecture · CQRS · Docker · CI/CD, deployed on Hetzner.\
> Includes a manual OWASP Top 10 security audit.
> 
> 🔗 [Live Demo](https://pare.kasian.dev) | 💻 [Source Code](https://github.com/shimiio/pare-app)
